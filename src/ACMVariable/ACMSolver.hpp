...
{
    /**
     * @brief Variable-density ACM solver for a compile-time equation model.
     * @tparam model Two- or three-dimensional variable-density ACM model.
     * @note Modifier: Runzhi Ma.
     */
    ...
    public:
        ...
        /** @brief Access geometry/reconstruction metrics for independent verification.
         * @return Shared initialized CFV instance; null before mesh initialization.
         * @author Runzhi Ma */
        const ssp<TVFV> &GetReconstruction() const { return _vfv; }

        /** @brief Access the variable-density spatial evaluator for derivative tests.
         * @return Shared initialized evaluator; null before mesh initialization.
         * @author Runzhi Ma */
    ...
    private:
        /**
         * @brief Run shared ODE engines, with separate physical DAE/pseudo-time ODE variables.
         * @details Differential histories contain [rho,m,0,rho*phi]; pressure is separately
         * stored per stage and its equation is the current divergence constraint, never dp/dt.
         * All numerical parameters are taken from the validated solver configuration.
         * @author Runzhi Ma
         */
        void RunGenericPhysical();
    ...
    extern template class ACMSolver<ACMModel::VariableDensity2D>;
    extern template class ACMSolver<ACMModel::VariableDensity3D>;
}
